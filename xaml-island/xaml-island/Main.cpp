...
int CALLBACK WinMain(
  ...
  // Makes the following constructor throw (Reunion Preview 0.5).
  ...
  SetWindowPos(hWndXamlIsland, 0, 200, 100, 800, 494, SWP_SHOWWINDOW);

  desktopSource.Content(winrt::xaml_island::HelloPage());
